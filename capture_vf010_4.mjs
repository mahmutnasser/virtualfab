...
async function capture() {
  ...
  try {
    ...
    const stationsToCapture = [
      { id: 'start', label: 'Start wafer', file: 'vf010_4_start.png' },
      { id: 'coat', label: 'Coat Resist', file: 'vf010_4_track_coat.png' },
      { id: 'develop', label: 'Develop', file: 'vf010_4_track_develop.png' },
      { id: 'adi', label: 'ADI Inspection', file: 'vf010_4_metrology_adi.png' },
      { id: 'aei', label: 'AEI Inspection', file: 'vf010_4_metrology_aei.png' },
      { id: 'etch', label: 'Etch', file: 'vf010_4_etch.png' },
      { id: 'strip', label: 'Strip', file: 'vf010_4_strip.png' },
      { id: 'repeat', label: 'Repeat', file: 'vf010_4_repeat.png' },
    ];
    ...
    const mobileFilePath = path.join(ARTIFACT_DIR, 'vf010_4_mobile.png');
    console.log('Capturing vf010_4_mobile.png ...');
    await mobilePage.screenshot({ path: mobileFilePath });

    await mobileContext.close();
    console.log('ALL 9 VF-010.4 VISUAL CHECKPOINT CAPTURES COMPLETED SUCCESSFULLY!');
  } catch (err) {
